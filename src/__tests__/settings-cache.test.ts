...
describe('Settings Cache', () => {
  ...
  describe('getMockLLM', () => {
    ...
    it('should return true when set', async () => {
      vi.mocked(query).mockResolvedValueOnce([{ key: 'mock_llm', value: 'true' }])
  ...
  describe('getLlmProvider', () => {
    ...
    it('should return anthropic when set', async () => {
      vi.mocked(query).mockResolvedValueOnce([{ key: 'llm_provider', value: 'anthropic' }])
    ...
    it('should return minimax when set', async () => {
      vi.mocked(query).mockResolvedValueOnce([{ key: 'llm_provider', value: 'minimax' }])
  ...
  describe('getOpenAIApiKey', () => {
    ...
    it('should return cached value', async () => {
      vi.mocked(query).mockResolvedValueOnce([{ key: 'openai_api_key', value: 'cached-key' }])
