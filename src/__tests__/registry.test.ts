...
describe('Agent Registry', () => {
  ...
  describe('setStatus', () => {
    it('should update agent status', async () => {
      ...
      expect(query).toHaveBeenCalledWith(expect.stringContaining('UPDATE agents SET status'), [
        'active',
        'agent-1',
      ])
    })
  ...
  describe('delete', () => {
    it('should delete agent', async () => {
      ...
      expect(query).toHaveBeenCalledWith(expect.stringContaining('DELETE FROM agents'), ['agent-1'])
    })
  })
