...
describe('Settings Service', () => {
  ...
  describe('setSetting', () => {
    it('should insert or update setting', async () => {
      ...
      expect(query).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO app_settings'), [
        'test_key',
        'test_value',
        null,
      ])
  ...
  describe('deleteSetting', () => {
    it('should delete setting', async () => {
      ...
      expect(query).toHaveBeenCalledWith(expect.stringContaining('DELETE FROM app_settings'), [
        'test_key',
      ])
    })
  })
  ...
  describe('getLLMSettings', () => {
    ...
    it('should parse mock_llm correctly', async () => {
      vi.mocked(query).mockResolvedValueOnce([{ key: 'mock_llm', value: 'false' }])
