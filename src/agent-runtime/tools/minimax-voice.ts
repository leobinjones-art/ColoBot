...
export function registerTools(): void {
  ...
  registerTool('list_voices', async (args) => {
    ...
    if (data.base_resp && data.base_resp.status_code !== 0) {
      throw new Error(
        `MiniMax list voices failed: ${data.base_resp.status_code} ${data.base_resp.status_msg}`,
      )
    }
  ...
  registerTool('voice_clone', async (args) => {
    ...
    if (data.base_resp && data.base_resp.status_code !== 0) {
      throw new Error(
        `MiniMax voice clone failed: ${data.base_resp.status_code} ${data.base_resp.status_msg}`,
      )
    }
  ...
  registerTool('voice_design', async (args) => {
    ...
    if (data.base_resp && data.base_resp.status_code !== 0) {
      throw new Error(
        `MiniMax voice design failed: ${data.base_resp.status_code} ${data.base_resp.status_msg}`,
      )
    }
  ...
  registerTool('delete_voice', async (args) => {
    ...
    if (data.base_resp && data.base_resp.status_code !== 0) {
      throw new Error(
        `MiniMax delete voice failed: ${data.base_resp.status_code} ${data.base_resp.status_msg}`,
      )
    }
