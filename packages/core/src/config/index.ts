...
export const DEFAULT_CONFIG: CoreConfig = {
  ...
  subAgent: {
    ...
    blockedTools: ['delete_file', 'execute_shell', 'system_access'],
  },
  audit: {
    enabled: true,
    level: 'info',
...
export class ConfigManager {
   ...
   * 合并配置
   */
  private mergeConfigs(base: CoreConfig, ...overrides: Partial<CoreConfig>[]): CoreConfig {
    let result = { ...base }
